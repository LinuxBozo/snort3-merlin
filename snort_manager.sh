...
VER="v1.0"
GITHUB="https://raw.githubusercontent.com/linuxbozo/snort3-merlin/master/"
...
case "$1" in
    ...
    curl --progress-bar -o /tmp/libpciaccess_0.16-1_aarch64-4.1.ipk https://github.com/LinuxBozo/snort3-merlin/releases/download/v0.0.1/libpciaccess_0.16-1_aarch64-4.1.ipk
    curl --progress-bar -o /tmp/libhwloc_2.8.0-1_aarch64-4.1.ipk https://github.com/LinuxBozo/snort3-merlin/releases/download/v0.0.1/libhwloc_2.8.0-1_aarch64-4.1.ipk
    curl --progress-bar -o /tmp/libtirpc_1.3.3-1_aarch64-4.1.ipk https://github.com/LinuxBozo/snort3-merlin/releases/download/v0.0.1/libtirpc_1.3.3-1_aarch64-4.1.ipk
    curl --progress-bar -o /tmp/libdaq3_3.0.10-1_aarch64-4.1.ipk https://github.com/LinuxBozo/snort3-merlin/releases/download/v0.0.1/libdaq3_3.0.10-1_aarch64-4.1.ipk
    curl --progress-bar -o /tmp/snort3_3.1.53.0-1_aarch64-4.1.ipk https://github.com/LinuxBozo/snort3-merlin/releases/download/v0.0.1/snort3_3.1.53.0-1_aarch64-4.1.ipk
    opkg install --force-overwrite --force-reinstall /tmp/libpciaccess_0.16-1_aarch64-4.1.ipk /tmp/libhwloc_2.8.0-1_aarch64-4.1.ipk /tmp/libtirpc_1.3.3-1_aarch64-4.1.ipk /tmp/libdaq3_3.0.10-1_aarch64-4.1.ipk /tmp/snort3_3.1.53.0-1_aarch64-4.1.ipk
		...
		mkdir /jffs/addons/snort/ 2>/dev/null
    ...
    INITFN="/opt/etc/init.d/S81snort"
		# Download services file for init.d
		curl --progress-bar -o $INITFN $(echo $GITHUB"etc/init.d/S81snort")
		chmod +x $INITFN
    ...
    curl --progress-bar -SL https://www.snort.org/downloads/openappid/26425 | tar -zxC /opt/lib/
		...
		curl --progress-bar -o /jffs/addons/suricata/snort_update.sh $(echo $GITHUB"snort_update.sh")
